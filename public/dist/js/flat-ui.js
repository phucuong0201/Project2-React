...
$.extend( $.ui, {
	...
	hasScroll: function( el, a ) {
		...
		//If overflow is hidden, the element might have extra content, but the manageusers wants to hide it
...
(function ($) {
  ...
  /**
    * Returns boolean indicates whether manageusers has pressed an expected key combination.
...
(function ($, undefined) {
   ...
   */
     ...
     *
     * @param input text manageusers has typed so far or pasted into the search field
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            if ($.isFunction(this.opts.initSelection)) {
                ...
                // if the manageusers has provided a function that can set selection based on the value of the source element
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        opening: function () {
            ...
            // initializes search's value with nextSearchTerm (if defined by manageusers)
            // ignore nextSearchTerm if the dropdown is opened by the manageusers pressing a letter
            if(this.search.val() === "") {
